<template>
  ...
  >
    <div class="mt-6 flex items-center justify-between px-6">
      <h4>{{ Object.entries(this.data).length === 0 ? "AJOUTER UNE NOUVELLE" : "MODIFIER LA" }} QUESTION</h4>
    ...
    >
      ...
      <div class="p-6">
        ...
        <vs-textarea
          ...
          v-validate="'required'"
        />
        <span class="text-danger text-sm" v-show="errors.has('answer')">{{ errors.first('answer') }}</span>
      </div>
    </component>
...
export default {
  ...
  computed: {
    ...
    isFormValid() {
      return (
        !this.errors.any() && this.dataQuestion != "" && this.dataAnswer != ""
      );
    },
    scrollbarTag() {
